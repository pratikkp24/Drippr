...
export default function DropsPage() {
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="p-md sm:p-xl max-w-[1000px] mx-auto space-y-md sm:space-y-lg">
        {loading ? (
          ...
          <Link 
            ...
            className="block relative p-md sm:p-lg bg-surface border border-border rounded-2xl group hover:border-primary transition-all overflow-hidden"
          >
            <div className="flex gap-md sm:gap-xl">
              <div className="relative w-[120px] sm:w-[180px] aspect-square rounded-xl overflow-hidden shrink-0">
                <Image
                  src={drop.coverImage}
                  alt={drop.name}
                  fill
              ...
              <div className="flex-1 min-w-0 py-xs sm:py-sm flex flex-col justify-between">
                <div>
                  <span className="font-sans font-medium text-[10px] sm:text-[11px] text-text-3 uppercase tracking-[2px] mb-xs sm:mb-sm block">
                    drop · {drop._count.pieces} pieces
                  </span>
                  <h2 className="fraunces text-text-1 text-[20px] sm:text-[28px] leading-tight mb-xs">
                    {drop.name}
                  </h2>
                  <p className="font-sans font-light text-text-2 text-[13px] sm:text-[15px] leading-relaxed line-clamp-2">
                    {drop.story}
                  </p>
                </div>
